...
namespace VirtualFileSystem
{
    ...
    /// </summary>
    [Serializable]
    public class VirtualPath : PathWrapper
    {
        ...
        public override string GetFullPath(string path)
        {
            ...
            if (root.Length == 0)
            {
                ...
                path = VirtualFileDataAccessor.Directory.GetCurrentDirectory() + DirectorySeparatorChar + path;
            ...
            else if (@"\".Equals(root, StringComparison.OrdinalIgnoreCase) || @"/".Equals(root, StringComparison.OrdinalIgnoreCase))
            {
                ...
                pathSegments = GetSegments(GetPathRoot(VirtualFileDataAccessor.Directory.GetCurrentDirectory()), path);
            }
            else
            {
                pathSegments = GetSegments(path);
            ...
            bool isUnixRooted =
                VirtualFileDataAccessor.Directory.GetCurrentDirectory()
